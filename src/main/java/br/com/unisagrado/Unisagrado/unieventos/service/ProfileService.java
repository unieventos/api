...
import br.com.unisagrado.Unisagrado.unieventos.exception.AccessTokenNotFound;
...
import br.com.unisagrado.Unisagrado.unieventos.repository.ProfileRepository;
...
public class ProfileService {
	...
	public void saveNewToken(String userLogin, Boolean stayLogged, String token) {
		...
		profileRepository.save(new Profile(userId, token, stayLogged));
	}
